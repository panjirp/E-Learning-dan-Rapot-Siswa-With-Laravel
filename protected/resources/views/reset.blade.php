        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="alert alert-danger">
                    <center>{{ session('messages') }}</center>
                </div>
                @endif
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" name="password_confirm" required>
                            </div>
                        </div>
