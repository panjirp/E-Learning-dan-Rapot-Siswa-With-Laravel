<article class="module width_full">
	<header><h3>DATA JURUSAN SMK</h3></header>

		<div class="module_content">		

	<button id="btn-add" name="btn-add" class="btn btn-primary btn-s" style="margin-bottom: 20px">Tambah Data Jurusan</button>
		...
		@else
			...
			@foreach($muridsmk as $index => $task)
				<tr id="row{{$task->id}}">
				<td>{{$index+1}}</td>
...
<!-- Modal (Pop up when detail button clicked) -->
                        ...
                        <div class="modal-body">
                            <form id="frmTasks" name="frmTasks" class="form-horizontal" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Jurusan" value="">
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <script src="{{asset('js/ajax-jurusan.js')}}"></script>